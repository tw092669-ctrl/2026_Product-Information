...
export const MOCK_AC_PRODUCTS: ACProduct[] = [
  ...
  { id: 'h-5', brand: '日立 (Hitachi)', model: 'RAM-50YP', type: '一對多', kind: '變頻', pipeSize: '2/3*2', environment: '暖氣', indoorDimensions: '', outdoorDimensions: '810 × 685 × 300', price: 24100, note: 'Hivx' },
  { id: 'h-6', brand: '日立 (Hitachi)', model: 'RAS-22NJP1', type: '一對多', kind: '變頻', pipeSize: '2/3', environment: '內機', indoorDimensions: '', outdoorDimensions: '', price: 14500, note: 'Hivx' },
  ...
  { id: 'p-6', brand: '國際 (Panasonic)', model: 'CU-2J45FHA2', type: '一對多', kind: '變頻', pipeSize: '2/3*2', environment: '暖氣', indoorDimensions: '', outdoorDimensions: '780 × 540 × 289', price: 23000, note: 'Pivx' },
  ...
  { id: 'm-2', brand: '三菱重工 (Mitsubishi Heavy)', model: 'DXM45ZST-W', type: '一對多', kind: '變頻', pipeSize: '2/3*2', environment: '暖氣', indoorDimensions: '', outdoorDimensions: '', price: 34400, note: 'Zivx' },
